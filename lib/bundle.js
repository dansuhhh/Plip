...
/***/ function(module, exports, __webpack_require__) {
	...
	const Extras = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const BounceScore = __webpack_require__(9);
	const PowerUpNotice = __webpack_require__(10);
...
/***/ function(module, exports) {
	...
	GameView.prototype.animate = function (currentTime) {
	  ...
	  if (this.game.isOver()){
	    ...
	    $('canvas').toggleClass('hide');
	    $('.extraScreen').toggleClass('hide');
	    if (!localStorage.getItem("highScore") || (this.game.score > localStorage.getItem("highScore"))){
